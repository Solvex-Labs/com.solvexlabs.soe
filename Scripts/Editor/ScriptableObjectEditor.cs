...
namespace SplashGames.Internal.SOE
{
    public class ScriptableObjectEditor : EditorWindow
    {
        ...
        [MenuItem("Tools/SplashGames/Scriptable Object Editor")]
        public static void ShowWindow()
        {
            var window = GetWindow<ScriptableObjectEditor>("Scriptable Object Editor");
